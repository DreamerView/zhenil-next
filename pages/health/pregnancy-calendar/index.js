        ...
        <>
            ...
            <div className="main">
                ...
                <div className={style.date_block}>
                    <input type="text" placeholder="Введите дату"  onFocus={(e) => (e.target.type = "date")} onBlur={(e) => (e.target.type = "text")} onChange={e=>setDate(e.target.value)} className={style.date} required/>
                </div>
