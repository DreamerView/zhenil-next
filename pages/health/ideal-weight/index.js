                        ...
                        <div className={style.module_result_row}>
                            <div className={style.module_result_block}>
                                <div className={style.module_result_block_pic}>
                                    <Image loading="lazy" priority src={male==='other'?"/emoji-small/restroom.webp":male==='male'?"/emoji-small/man_raising_hand.webp":"/emoji-small/woman_raising_hand.webp"} layout="fill" alt="emoji"/>
                                </div>
                                <div>
                            ...
                            <div className={style.module_result_block}>
                                <div className={style.module_result_block_pic}>
                                    <Image loading="lazy" priority src={male==='other'?"/emoji-small/restroom.webp":male==='male'?"/emoji-small/man_standing.webp":"/emoji-small/woman_standing.webp"} layout="fill" alt="emoji"/>
                                </div>
                                <div>
                            ...
                            <div className={style.module_result_block}>
                                <div className={style.module_result_block_pic}>
                                    <Image loading="lazy" priority src={male==='other'?"/emoji-small/restroom.webp":male==='male'?"/emoji-small/man_gesturing_ok.webp":"/emoji-small/woman_gesturing_ok.webp"} layout="fill" alt="emoji"/>
                                </div>
                                <div>
